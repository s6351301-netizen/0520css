...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .nav-item span { color: #6b7280; font-size: 0.95rem; }
        main {
            padding: 2rem;
            display: grid;
        ...
        .icon-button.active { background: var(--accent); color: #fff; }
...
<body>
    <header>
        <div class="hero">
            <div>
                <p class="chip">最新網頁設計 / CSS Grid / sticky / absolute</p>
                <h1>9 件商品畫廊與 PHP 購物車示範</h1>
                <p>使用 position、absolute、sticky 與現代 hover 特效。點擊愛心或購物車，會透過 PHP + SQLite 存入我的最愛與購物車。</p>
            </div>
        ...
        <div class="nav-carousel" id="bestSellers">
            <div class="nav-item pulse"><strong>極簡座椅</strong><span>週銷售冠軍</span></div>
            <div class="nav-item"><strong>設計落地燈</strong><span>熱銷新品</span></div>
            <div class="nav-item"><strong>北歐抱枕</strong><span>人氣推薦</span></div>
            <div class="nav-item"><strong>手工餐桌</strong><span>居家首選</span></div>
            <div class="nav-item"><strong>綠意盆栽</strong><span>風格必備</span></div>
        </div>
    </header>
    <?php if ($message): ?>
